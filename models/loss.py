...
def weighted_dice_loss(
    ...
    Args:
        ...
        eps: the minimum eps,
    """
    target_seg = F.one_hot(target_seg)  # (B, N, n_classes)
    b, n, n_classes = target_seg.shape

    target_seg = target_seg.view(-1, n_classes)
    prediction = prediction.transpose(1, 2).view(-1, n_classes)
