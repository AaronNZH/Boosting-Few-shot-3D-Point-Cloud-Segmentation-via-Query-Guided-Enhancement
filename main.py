...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_way', type=int, default=1, help='Number of classes for each episode: 1|3')
    ...
    if args.phase == 'mptitrain':
        args.log_dir = args.save_path + 'log_mpti_%s_S%d_N%d_K%d' % (args.dataset, args.cvfold, args.n_way, args.k_shot)
