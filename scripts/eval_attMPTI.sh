...
MODEL_CHECKPOINT='./log_s3dis/log_mpti_s3dis_S0_N1_K1_Att1' #MAKE SURE IT CORRESPONDS TO SPLIT, N_WAY, K_SHOT.`
N_WAY=2
K_SHOT=1
N_QUESIES=1
N_TEST_EPISODES=800
...
args=(--phase 'mptieval'  --dataset "${DATASET}" --cvfold $SPLIT
      ...
      --dist_method "$SIM_FUNCTION" --mpti_sigma $SIGMA --use_attention
